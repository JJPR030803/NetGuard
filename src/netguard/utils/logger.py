...
Quick start:
    from netguard.utils.logger import NetworkSecurityLogger
...
Notes:
- By default, file-based handlers write under log_dir (defaults to /tmp/netguard).
    ...
    def __init__(
        ...
        Args:
            ...
            log_dir (Optional[str]): Base directory where file handlers should
                write logs. Defaults to "/tmp/netguard" if not provided.
        """
        self.log_dir = log_dir or "/tmp/netguard"
